...
public class UI { // UI = User Interface
	...
	// https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
		...
		public static ChessPosition readChessPosition(Scanner sc) { /*ele recebe o 
		scanner lá do programa principal. Esse scanner vai ser instanciado la no programa principal e ele vai ser
		recebido como argumento. Será feita a leitura da posição utilizando esse mesmo Scanner.*/
			try {
				String s = sc.nextLine();
				char column = s.charAt(0);
				int row = Integer.parseInt(s.substring(1)); /*Eu vou recortar meu String a partir da posicao 1 
				(s.substring(1) e vou converter o meu resultado para inteiro Integer.(parseInt), entao terei 
				minha linha*/
				return new ChessPosition(column, row); //construtor
			} 
